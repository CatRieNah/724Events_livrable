  ...
  return <>
    ...
    <footer className="row">
      <div className="col presta">
        ...
        {/* Ajout des valeurs par défaut pour éviter que imageSrc et title soient indéfini */}
        <EventCard
          imageSrc={last?.cover || "public/images/evangeline-shaw-nwLTVwb7DbU-unsplash1.png"}
